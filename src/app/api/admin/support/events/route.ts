// src/app/api/admin/support/events/route.ts
// SSE stream for real-time support events (attachment scan results, new messages)
...
export async function GET(req: NextRequest) {
  ...
  if (!can(user, 'support')) return new Response('Forbidden', { status: 403 })
